...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "XTREME~XMD~vkwEhC5A#ZS_ds-_S53QutDUwjXVeadURpsUgwluhUaNaJqgyqfQ",
// add your Session Id 
...
OWNER_NAME: process.env.OWNER_NAME || "𝚩𝚫𝐃 𝚸𝚪𝚰𝚴𝐂𝚵",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝚩𝚫𝐃 𝚸𝚪𝚰𝚴𝐂𝚵*",
// add bot owner name    
